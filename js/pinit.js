	...
	var a = n[m.k] = {
		...
		f : function() {
			return {
				...
				get : function(b, d) {
					var c = null;
					return c = typeof b[d] === "string" ? b[d] : b.getAttribute(d)
				},
				...
				make : function(b) {
					...
					if (b[c].hasOwnProperty) {
						...
						for (e in b[c])b[c][e].hasOwnProperty && typeof b[c][e] === "string" && a.f.set(d, e, b[c][e]);
						break
					}
					return d
				},
				...
				getEl : function(b) {
					var d = null;
					return d = b.target ? b.target.nodeType === 3 ? b.target.parentNode : b.target : b.srcElement
				},
				listen : function(b, d, c) {
					if ( typeof a.w.addEventListener !== "undefined")
						b.addEventListener(d, c, false);
					else
						typeof a.w.attachEvent !== "undefined" && b.attachEvent("on" + d, c)
				},
				call : function(b, d) {
					var c, e, f = "?";
				...
				debug : function(b) {
					a.v.config.debug && a.w.console && a.w.console.log && a.w.console.log(b)
				},
				...
				showFloatingButton : function(b) {
					if (b.height > a.a.minImgSize && b.width > a.a.minImgSize && !b.src.match(/^data/)) {
						if (!a.s.floatingButton) {
							a.s.floatingButton = a.f.make({
								A : {
									className : a.a.k + "_pin_it_button " + a.a.k + "_pin_it_button_floating",
									title : "Pin it!",
									target : "_blank"
								}
							});
							a.f.set(a.s.floatingButton, a.a.dataAttributePrefix + "log", "button_pinit_floating");
							a.d.b.appendChild(a.s.floatingButton)
						}
						var d = a.f.getPos(b), c = a.a.endpoint.create;
						c = c + "url=" + encodeURIComponent(a.d.URL) + "&media=" + encodeURIComponent(b.src) + "&description=" + encodeURIComponent(b.getAttribute("data-pin-description") || b.title || b.alt || a.d.title);
						...
						a.s.floatingButton.style.top = d.top + a.a.floatingButtonOffsetTop + "px";
						a.s.floatingButton.style.left = d.left + a.a.floatingButtonOffsetLeft + "px";
						a.s.floatingButton.style.display = "block"
					}
				},
				over : function(b) {
					if ( b = a.f.getEl(b || a.w.event))
						if (b.tagName === "IMG" && b.src && !a.f.getData(b, "no-hover") && !a.f.get(b, "nopin") && a.v.config.hover) {
				...
				click : function(b) {
					...
					if ( b = a.f.getEl(b)) {
						if ( d = a.f.getData(b, "log"))
							a.f.log("&type=" + d + "&href=" + encodeURIComponent(b.href || a.f.getData(b, "href")));
				...
				behavior : function() {
					...
					a.v.config.hover && a.f.listen(a.d.b, "mouseover", a.f.over)
				},
				getPinCount : function(b) {
					b = "?url=" + b + "&ref=" + encodeURIComponent(a.v.here) + "&source=" + a.a.countSource;
					a.f.call(a.a.endpoint.count + b, a.f.ping.count)
				},
				prettyPinCount : function(b) {
					if (b > 999)
						b = b < 1E6 ? parseInt(b / 1E3, 10) + "K+" : b < 1E9 ? parseInt(b / 1E6, 10) + "M+" : "++";
					return b
				},
				tile : function(b, d) {
					...
					if (( e = a.f.getData(b, "scale-width")) && e >= a.a.tile.scale.minWidth)
					...
					a.v.renderedWidth = e * (c.width + a.a.tile.style.margin) - a.a.tile.style.margin;
					...
					for (var g = 0, h = [], k = 0, p = d.length; k < p; k += 1) {
						...
						a.f.set(j, a.a.dataAttributePrefix + "log", "embed_board");
						var i = {
							height : d[k].images["237x"].height * (c.width / d[k].images["237x"].width),
							width : c.width
						}, l = a.f.make({
							IMG : {
						...
						l.style.marginTop = 0 - i.height / a.a.tile.style.margin + "px";
						...
						h[g] || (h[g] = 0);
						j.style.top = h[g] + "px";
						j.style.left = g * (c.width + a.a.tile.style.margin) + "px";
				...
				ping : {
						...
						if ( d = a.d.getElementById(a.a.k + "_pin_count_" + d)) {
							...
							if (b.count === 0)
								if (e === "above") {
									...
									d.className = a.a.k + "_pin_it_button_count";
									d.appendChild(a.d.createTextNode("0"))
								} else
									a.f.debug("Zero pin count not rendered to the side.");
							if (b.count > 0) {
								a.f.debug("Got " + b.count + " pins for the requested URL.");
								if (e === "above" || e === "beside") {
									a.f.debug("Rendering pin count " + e);
									d.className = a.a.k + "_pin_it_button_count";
									d.appendChild(a.d.createTextNode(a.f.prettyPinCount(b.count)))
								} else
									a.f.debug("No valid pin count position specified; not rendering.")
							}
							a.f.cssHook(c, d)
						} else
					...
					pin : function(b, d) {
						if (( d = a.d.getElementById(a.a.k + "_" + d)) && b.data && b.data[0]) {
							a.f.debug("API replied with pin data");
							b = b.data[0];
							var c = {};
							if (b.images)
								c = b.images["237x"];
							if (b && b.id && b.description && c.url && c.width && c.height) {
								...
								if (a.f.getData(d, "style") !== "plain")
									e.className = e.className + " " + a.a.k + "_fancy";
								var f = a.f.make({
									A : {
										className : a.a.k + "_embed_pin_link",
										title : b.description,
										href : "http://pinterest.com/pin/" + b.id + "/",
										target : "_blank"
									}
								}), g = a.f.make({
									IMG : {
								...
								a.f.set(g, a.a.dataAttributePrefix + "log", "image_from_embedded_pin");
								a.f.set(g, a.a.dataAttributePrefix + "href", "http://pinterest.com/pin/" + b.id + "/");
								...
								a.f.set(c, a.a.dataAttributePrefix + "log", "repin");
								a.f.set(c, a.a.dataAttributePrefix + "href", a.a.endpoint.repin.replace(/%s/, b.id));
								f.appendChild(c);
								c.onclick = function() {
									if (!this.className.match(/hazClick/))
										this.className = this.className + " " + a.a.k + "_hazClick";
									var h = a.a.endpoint.repin.replace(/%s/, a.f.get(this, "data-pin-id"));
									a.w.open(h, "pin" + (new Date).getTime(), a.a.popLarge);
									return false
								};
								c = a.f.make({
									I : {
										className : a.a.k + "_getThis",
										innerHTML : a.v.strings.getThis + "<i></i>",
										"data-pin-id" : b.id
									}
								});
								f.appendChild(c);
								...
								a.f.set(f, a.a.dataAttributePrefix + "log", "embed_pin");
								e.appendChild(f);
								f = a.f.make({
									SPAN : {
								...
								if (b.attribution && b.attribution.url && b.attribution.author_name && b.attribution.provider_icon_url) {
									...
									c.appendChild(a.f.make({
										SPAN : {
											className : a.a.k + "_embed_pin_attrib",
											innerHTML : a.v.strings.attribTo + ' <a href="' + b.attribution.url + '" target="_blank">' + b.attribution.author_name + "</a>"
										}
									}));
									f.appendChild(c)
								}
								e.appendChild(f);
								if (b.pinner && b.pinner.profile_url && b.pinner.image_small_url && b.pinner.full_name) {
									...
									f.appendChild(a.f.make({
										SPAN : {
											...
											innerHTML : a.v.strings.pinnedBy + ' <em class="' + a.a.k + '_embed_pin_text_container_em">' + b.pinner.full_name + "</em>"
										}
									}));
									c = a.f.make({
										B : {
									...
									a.f.set(c, a.a.dataAttributePrefix + "log", "pinner_from_embedded_pin");
									a.f.set(c, a.a.dataAttributePrefix + "href", b.pinner.profile_url);
									f.appendChild(c);
									e.appendChild(f)
								}
								if (b.board && b.board.url && b.board.image_thumbnail_url && b.board.name) {
									a.f.debug("Building board line");
									if (!b.board.url.match(/^(\/\/pinterest\.com|http:\/\/pinterest\.com|https:\/\/pinterest\.com)/)) {
										b.board.url = "//pinterest.com" + b.board.url;
										a.f.debug("appending Pinterest prefix to board URL")
									}
									f = a.f.make({
										A : {
											className : a.a.k + "_embed_pin_text",
									...
									f.appendChild(a.f.make({
										SPAN : {
											className : a.a.k + "_embed_pin_text_container",
											innerHTML : a.v.strings.onto + ' <em class="' + a.a.k + '_embed_pin_text_container_em">' + b.board.name + "</em>"
										}
									}));
									c = a.f.make({
										B : {
									...
									a.f.set(c, a.a.dataAttributePrefix + "log", "board_from_embedded_pin");
									a.f.set(c, a.a.dataAttributePrefix + "href", b.board.url);
									f.appendChild(c);
									e.appendChild(f)
								}
								a.f.cssHook(d, e);
					...
					user : function(b, d) {
						if (( d = a.d.getElementById(a.a.k + "_" + d)) && b.data && b.data.pins && b.data.pins.length) {
							...
							if (a.f.getData(d, "style") !== "plain")
								c.className = c.className + " " + a.a.k + "_fancy";
							var e = a.f.make({
								SPAN : {
							...
							a.f.set(f, a.a.dataAttributePrefix + "log", "embed_user");
							e.appendChild(f);
							c.appendChild(e);
					...
					board : function(b, d) {
						if (( d = a.d.getElementById(a.a.k + "_" + d)) && b.data && b.data.pins && b.data.pins.length) {
							...
							a.f.set(g, a.a.dataAttributePrefix + "log", "embed_board");
							f.appendChild(g);
							if (a.v.renderedWidth > a.a.tile.minWidthToShowAuxText) {
								b = a.f.make({
									A : {
										...
										innerHTML : "<span>" + a.v.strings.attribTo + "</span> " + b.data.user.full_name,
										target : "_blank",
										href : d.href
									}
								});
								a.f.set(b, a.a.dataAttributePrefix + "log", "embed_board");
								f.appendChild(b)
							} else
				...
				percentEncode : function(b) {
					if (decodeURIComponent(b) === b) {
						b = encodeURIComponent(b);
						a.f.debug("encoded string: " + b)
					}
					return b
				},
				fixUrl : function(b) {
					b = a.f.percentEncode(b);
					if (!b.match(/^http/)) {
						b = "http%3A%2F%2F" + b;
						a.f.debug("prepended scheme: " + b)
					}
					return b
				},
				render : {
					buttonBookmark : function(b) {
						...
						var d = a.f.make({
							A : {
								href : b.href,
								className : a.a.k + "_pin_it_button " + a.a.k + "_pin_it_button_inline"
							}
						});
						a.f.set(d, a.a.dataAttributePrefix + "log", "button_pinit_bookmarklet");
						var c = a.f.getData(b, "config");
						if (a.a.config.pinItCountPosition[c] === true) {
							a.f.set(d, a.a.dataAttributePrefix + "config", c);
							d.className = d.className + " " + a.a.k + "_pin_it_" + c
						} else
							d.className = d.className + " " + a.a.k + "_pin_it_none";
					...
					buttonPin : function(b) {
						...
						if (d.media)
							d.media = a.f.fixUrl(d.media);
						else {
							d.media = "";
							a.f.debug("no media found; click will pop bookmark")
						}
						if (d.url)
							d.url = a.f.fixUrl(d.url);
						else {
							d.url = encodeURIComponent(a.d.URL);
							a.f.debug("no url found; click will pin this page")
						}
						if (!d.description)
							d.description = "";
						var c = a.f.make({
							A : {
								href : a.a.endpoint.create + "url=" + d.url + "&media=" + d.media + "&description=" + d.description,
								className : a.a.k + "_pin_it_button " + a.a.k + "_pin_it_button_inline",
								target : "_blank"
							}
						});
						a.f.set(c, a.a.dataAttributePrefix + "log", "button_pinit");
						var e = a.f.getData(b, "config");
						if (a.a.config.pinItCountPosition[e] === true) {
							a.f.set(c, a.a.dataAttributePrefix + "config", e);
							c.className = c.className + " " + a.a.k + "_pin_it_" + e
						} else
							c.className = c.className + " " + a.a.k + "_pin_it_none";
						c.onclick = function() {
							var f = a.f.parse(this.href, {
								url : true,
								media : true
							});
							if (f.url && f.url.match(/^http/) && f.media && f.media.match(/^http/))
								a.w.open(this.href, "pin" + (new Date).getTime(), a.a.pop);
							else {
								a.f.log("&type=config_error&error_msg=invalid_url&href=" + encodeURIComponent(a.d.URL));
								a.f.fireBookmark()
							}
							return false
						};
					...
					buttonFollow : function(b) {
						...
						if (b.href.split("/")[3]) {
							...
							a.f.set(d, a.a.dataAttributePrefix + "log", "button_follow");
							a.f.replace(b, d)
						}
					},
					embedPin : function(b) {
						a.f.debug("build embedded pin");
						( b = b.href.split("/")[4]) && parseInt(b, 10) > 0 && a.f.getPinsIn("pin", "", {
							pin_ids : b
						})
					},
					...
					embedBoard : function(b) {
						...
						b = b.href.split("/")[4];
						d && b && a.f.getPinsIn("board", d + "/" + b + "/pins/")
					}
				},
				...
				config : function() {
					...
					a.v.firstScript = b[0];
					for ( c = 0; c < d; c += 1)
						if (a.a.me && b[c] && b[c].src && b[c].src.match(a.a.me)) {
							if (e === false) {
								for ( e = 0; e < a.a.configParam.length; e += 1)
									a.v.config[a.a.configParam[e]] = a.f.get(b[c], a.a.dataAttributePrefix + a.a.configParam[e]);
								e = true
							}
							a.f.kill(b[c])
						}
